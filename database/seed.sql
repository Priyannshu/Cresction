-- Seed data for Cresction E-commerce Platform

-- Categories
INSERT INTO product_service.categories (id, name, description) VALUES 
  (uuid_generate_v4(), 'Electronics', 'Latest gadgets and electronic devices'),
  (uuid_generate_v4(), 'Clothing', 'Fashionable apparel and accessories'),
  (uuid_generate_v4(), 'Home & Garden', 'Home decor and garden essentials'),
  (uuid_generate_v4(), 'Sports', 'Athletic gear and equipment'),
  (uuid_generate_v4(), 'Books', 'Bestselling books and publications')
